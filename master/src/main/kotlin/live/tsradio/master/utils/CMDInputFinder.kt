    ...
    fun findValue(attributeName: String, throwError: Boolean = false): String? {
        ...
        try {
            if(cmdArguments.contains(formatedAttr)){
                ...
                if(throwError) throw Exception("Cannot find a value for attribute '$formatedAttr'. This could cause reduced functionality in further tasks. Please consider setting a value for that command line property")
            }
