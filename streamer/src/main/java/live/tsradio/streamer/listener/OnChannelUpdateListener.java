...
public class OnChannelUpdateListener implements RedisEvent {
    private static final Logger logger = LoggerFactory.getLogger(OnChannelUpdateListener.class);
    ...
    public void onEvent(String channel, String message) {
        try {
            ...
            ChannelHandler.updateOrRegisterChannel((String) json.get("uuid"), json);
        } catch (Exception e) {
